    ...
    services = {
      ...
      hermes-agent = {
        ...
        documents."AGENTS.md" = ''
          ...
          Unless the user explicitly specifies a different rule or method for handling images, whenever you generate an image, chart/plot (e.g. using Python matplotlib), or take a screenshot:
          ...
          If the user explicitly requests a different rule or format for images/charts, follow the user's specific instructions instead.
        '';
