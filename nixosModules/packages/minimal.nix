          ...
          config = lib.mkMerge [
            ...
            }
            {
              programs =
                let
                  optional = lib.mkIf (
                    builtins.elem home-inputs.config.home.username [
                      "chn"
                      "root"
                      "aleksana"
                      "alikia"
      ...
      nixos.user.sharedModules = [
        (homeInputs: {
          config = {
            ...
            programs.bash = {
              enable = true;
              historyFile = "${homeInputs.config.xdg.dataHome}/bash/bash_history";
            };
