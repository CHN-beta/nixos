inputs: rec
{
  ...
  ufo = inputs.pkgs.callPackage inputs.flakeInputs.ufo { inherit biu matplotplusplus; tbb = inputs.pkgs.tbb_2022; };
  ...
  debug-kernel310-hang = inputs.pkgs.callPackage ./debug-kernel310-hang { inherit biu; };
